...
#ENDIF
;
#IF (TMSMODE == TMSMODE_LOT)
TMS_DATREG	.EQU	$72		; READ/WRITE DATA
TMS_CMDREG	.EQU	$73		; READ STATUS / WRITE REG SEL
TMS_PPIA	.EQU	0		; PPI PORT A
TMS_PPIB	.EQU	0		; PPI PORT B
TMS_PPIC	.EQU	0		; PPI PORT C
TMS_PPIX	.EQU	0		; PPI CONTROL PORT
...
TMS_ROWS	.EQU	24
;
#IF ((TMSMODE == TMSMODE_MSX9958) | (TMSMODE == TMSMODE_MBC) | (TMSMODE == TMSMODE_LOT))
