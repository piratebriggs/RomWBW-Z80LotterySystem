...
; So, we map HBIOS banks $80-$8F (RAM SELECT) to $00-$0F.
; And also map $00-$0F (ROM SELECT) to $00-$0F
; We only have banks 0-2 available
;
	BIT	7,A				; BIT 7 SET REQUESTS RAM PAGE
	JR	Z,HBX_ROM		; NOT SET, SELECT ROM PAGE
...
HBX_ROM:
	PUSH AF
	LD   A,$0D			; SETBANK
	OUT	 ($01),A		; STORE OPCODE
	POP  AF
	OUT	 ($00),A		; EXECUTE WRITE OPCODE
	RET					; DONE
#ENDIF
;
;
