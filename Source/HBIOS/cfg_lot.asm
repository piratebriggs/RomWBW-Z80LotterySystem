...
;
RAMSIZE		.EQU	(32*7)		; SIZE OF RAM IN KB (MUST MATCH YOUR HARDWARE!!!)
ROMSIZE		.EQU	(32*8)		; SIZE OF ROM IN KB (MUST MATCH YOUR HARDWARE!!!)
MEMMGR		.EQU	MM_LOT		; MEMORY MANAGER: MM_[SBC|Z2|N8|Z180|Z280|MBC|RPH|MON]
PPI_PORTA   .EQU    $14     ; 20
PPI_PORTB   .EQU    $15     ; 21
PPI_PORTC   .EQU    $16     ; 22
PPI_CTL     .EQU    $17     ; 23
PPI_CTL_DAT	.EQU    11000000B   ; Active, GRP A: Mode 2 (Bidi), Port B & PC0-2 Outputs
;
...
FPLED_IO	.EQU	$15		; FP: PORT ADDRESS FOR FP LEDS
...
LEDPORT		.EQU	$15 		; STATUS LED PORT ADDRESS
...
;
DS1216RTCENABLE	.EQU	TRUE		; DS1216RTC: ENABLE DS-1216 SmartWatch RAM CLOCK DRIVER (DS1216RTC.ASM)
;
...
CH0BASE		.EQU	PPI_PORTA		; CH 0: BASE I/O ADDRESS
