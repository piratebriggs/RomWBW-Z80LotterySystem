;
;==================================================================================================
;   ROMWBW 3.X CONFIGURATION DEFAULTS FOR Lottery SBC
;==================================================================================================
;
...
; FOR THE PLATFORM.
;
#DEFINE PLATFORM_NAME "Lottery SBC", " [", CONFIG, "]"
;
#INCLUDE "hbios.inc"
;
PLATFORM	.EQU	PLT_LOT		; PLT_[SBC|ZETA|ZETA2|N8|MK4|UNA|RCZ80|RCZ180|EZZ80|SCZ180|DYNO|RCZ280|MBC|RPH|Z80RETRO|S100|DUO|HEATH|MON]
...
CPUOSC		.EQU	4915200     ; CPU OSC FREQ IN MHZ
INTMODE		.EQU	0		; INTERRUPTS: 0=NONE, 1=MODE 1, 2=MODE 2, 3=MODE 3 (Z280)
DEFSERCFG	.EQU	SER_19200_8N1	; DEFAULT SERIAL LINE CONFIG (SEE STD.ASM)
;
RAMSIZE		.EQU	(32*4)		; SIZE OF RAM IN KB (MUST MATCH YOUR HARDWARE!!!)
ROMSIZE		.EQU	0   		; SIZE OF ROM IN KB (MUST MATCH YOUR HARDWARE!!!)
MEMMGR		.EQU	MM_LOT		; MEMORY MANAGER: MM_[SBC|Z2|N8|Z180|Z280|MBC|RPH|MON]
PPI_PORTA   .EQU    $14     ; 20
PPI_PORTB   .EQU    $15     ; 21
PPI_PORTC   .EQU    $16     ; 22
PPI_CTL     .EQU    $17     ; 23
PPI_CTL_DAT	.EQU    10000000B   ; Active, Mode 0, Port A, B & C Outputs
;
RTCIO		.EQU	$04		; RTC LATCH REGISTER ADR. Make sure writing to this does nothing
;
...
FPLED_IO	.EQU	$16		; FP: PORT ADDRESS FOR FP LEDS
FPLED_INV	.EQU	FALSE		; FP: LED BITS ARE INVERTED
FPLED_DSKACT	.EQU	TRUE		; FP: ENABLES DISK I/O ACTIVITY ON FP LEDS
DIAG_DISP   .SET    DIAG_7SEG
...
LEDPORT		.EQU	$16 		; STATUS LED PORT ADDRESS
...
VDAEMU_SERKBD	.EQU	0		; VDA EMULATION: SERIAL KBD UNIT #, OR $FF FOR HW KBD
...
;
DS1216RTCENABLE	.EQU	FALSE		; DS1216RTC: ENABLE DS-1216 SmartWatch RAM CLOCK DRIVER (DS1216RTC.ASM)
;
...
SIODEBUG	.EQU	TRUE		; SIO: ENABLE DEBUG OUTPUT
...
SIO0ACLK	.EQU	(CPUOSC/16)	; SIO 0A: OSC FREQ IN HZ, 4915200/16 = 307200
SIO0ACFG	.EQU	DEFSERCFG	; SIO 0A: SERIAL LINE CONFIG
SIO0ACTCC	.EQU	-1		; SIO 0A: CTC CHANNEL 0=A, 1=B, 2=C, 3=D, -1 FOR NONE
SIO0BCLK	.EQU	(CPUOSC/16)	; SIO 0B: OSC FREQ IN HZ, 
...
TMSMODE		.EQU	TMSMODE_LOT	; TMS: DRIVER MODE: TMSMODE_[SCG|N8|MBC|MSX|MSX9958|MSXKBD|COLECO]
...
;
MDENABLE	.EQU	FALSE		; MD: ENABLE MEMORY (ROM/RAM) DISK DRIVER (MD.ASM)
MDROM		.EQU	FALSE		; MD: ENABLE ROM DISK
MDRAM		.EQU	FALSE		; MD: ENABLE RAM DISK
...
CHSDTRACE	.EQU	0		; CHSD: TRACE LEVEL (0=NO,1=ERRORS,2=ALL)
CHCNT		.EQU	1		; CH: NUMBER OF BOARDS TO DETECT (1-2)
CH0BASE		.EQU	$70		; CH 0: BASE I/O ADDRESS
