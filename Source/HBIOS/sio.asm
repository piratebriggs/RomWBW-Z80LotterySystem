...
;
SIO_INITDEFS:
	.DB	%00000000, %00011000		; WR0: CHANNEL RESET CMD
	.DB	%00010100, %01000100		; WR4: /16, async mode, no parity
	.DB	%00000001, SIO_WR1VAL		; WR1: INTERRUPT STYLE
	.DB	%00000010, %00000000		; WR2: IM2 VEC OFFSET
	.DB	%00000011, %11000001		; WR3: Receive enable, 8 bit 
	.DB	%00000101, SIO_RTSON		; WR5: Wr5 Transmit enable, 8 bit, flow ctrl
;
