...
;
SIO_INITDEFS:
	.DB	$00, %00011000		; WR0: CHANNEL RESET CMD
	.DB	$04, %01000100		; WR4: /16, async mode, no parity
	.DB	$01, SIO_WR1VAL		; WR1: INTERRUPT STYLE
	.DB	$02, %00000000		; WR2: IM2 VEC OFFSET
	.DB	$03, %11000001		; WR3: Receive enable, 8 bit 
	.DB	$05, SIO_RTSON		; WR5: Wr5 Transmit enable, 8 bit, flow ctrl
;
