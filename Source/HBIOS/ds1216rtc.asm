...
;
	; COPY ROUTINES TO UPPER RAM
	LD	HL,DS1216_LOWER
	LD	DE,$F000
	LD	BC,DS1216_UPPERSIZ
	LDIR
;
...
DS1216_BCD:
	...
	RET
;
DS_LOCATION:	.DB	$00         	; one byte in HBIOS bank to communicate with smartwatch
...
;
DS1216_BUF:	.FILL	8,0				; BUFFER FOR TIME, DATE AND CONTROL
;
DS1216_UPPERSIZ	.EQU	$-DS1216_UPPER	; SIZE OF ROUTINE

	.ORG	DS1216_LOWER+DS1216_UPPERSIZ		; BACK TO ABSOLUTE ADDRESS
